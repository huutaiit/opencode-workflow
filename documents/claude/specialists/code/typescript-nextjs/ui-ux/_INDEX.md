# UI-UX Specialist Stack — Next.js (Ant Design 5 + Tailwind CSS v4)

- **Stack**: typescript-nextjs
- **Total**: 36 specialists
- **Range**: 200.x–258.x
- **Variant**: default (Ant Design 5 + Tailwind CSS v4)
...
|-----------------|------------------------|-----------|
| 200 color-system | 59.x theme-specialist | 59.x wins on conflict |
| 202 typography-scale | 96.x web-design-guidelines | 96.x wins on conflict |
| 204 border-radius | 119.x tailwind-css-specialist | 119.x wins on conflict |
| 221 hover-interaction | 96.x web-design-guidelines | 96.x wins on conflict |
| 224 focus-accessibility | 96.x web-design-guidelines | 96.x wins on conflict |
| 225 empty-error-loading | 82.x crud-page-patterns | 82.x wins on conflict |
| 228 navigation-ux | 82.x crud-page-patterns | 82.x wins on conflict |
