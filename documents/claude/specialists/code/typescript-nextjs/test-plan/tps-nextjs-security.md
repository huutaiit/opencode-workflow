# Test Plan Specialist — NextJS Security Testing
# テストプランスペシャリスト — NextJS Security Testing
# Chuyen Gia Test — NextJS Security Testing
...
Verify: next.config.js headers include Content-Security-Policy. Test: inline scripts blocked, eval blocked, unsafe-inline only for trusted sources.
...
*Test Plan Specialist — NextJS Security Testing | EPS v10.0*
