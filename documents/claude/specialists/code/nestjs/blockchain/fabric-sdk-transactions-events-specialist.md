# Fabric SDK Transactions & Events Specialist — Infrastructure
# Fabric SDKトランザクション＆イベントスペシャリスト — インフラストラクチャ
# Chuyen Gia Giao Dich & Su Kien SDK Fabric — Ha Tang

**Version**: 1.0.0
**Technology**: Hyperledger Fabric 2.x + fabric-network SDK + NestJS
**Aspect**: Transaction Execution, Event Listeners, Checkpointing
**Category**: infrastructure
**Purpose**: Knowledge provider for Fabric SDK Transactions & Events Specialist patterns
...
```json
{
  "id": "fabric-sdk-transactions-events",
  "technology": "Hyperledger Fabric 2.x + fabric-network SDK + NestJS",
  "aspect": "Transaction Execution, Event Listeners, Checkpointing",
  "category": "infrastructure",
  "subcategory": "nestjs",
...
| **Variant** | ALL |
| **Pattern Numbers** | 236.1–236.8 |
| **Directory Pattern** | `src/infrastructure/blockchain/sdk/` |
...
| **Purpose** | Fabric SDK transactions and events — commit listeners, block events, replay |
| **Activation Trigger** | files: **/blockchain/sdk/**; keywords: fabricEvent, blockListener, transactionEvent |

---

## Role

You are a **Fabric SDK Transactions & Events Specialist**. Refer to the patterns below for implementation guidance.
