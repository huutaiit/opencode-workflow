# Fabric SDK Client & Gateway Specialist — Infrastructure
# Fabric SDKクライアントゲートウェイスペシャリスト — インフラストラクチャ
# Chuyen Gia SDK Client & Gateway Fabric — Ha Tang

**Version**: 1.0.0
**Technology**: Hyperledger Fabric 2.x + fabric-network SDK + NestJS
**Aspect**: SDK Connection, Discovery, Timeouts, Handlers, Retry
**Category**: infrastructure
**Purpose**: Knowledge provider for Fabric SDK Client & Gateway Specialist patterns
...
| **Purpose** | Fabric SDK client — gateway connection, identity, network discovery |
| **Activation Trigger** | files: **/blockchain/sdk/**; keywords: fabricGateway, connect, identity, discovery |

---

## Role

You are a **Fabric SDK Client & Gateway Specialist**. Refer to the patterns below for implementation guidance.
